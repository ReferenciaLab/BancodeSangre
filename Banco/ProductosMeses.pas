...
type
  TfrmProductosMeses = class(TfrmDatosModule)
    ...
    qrVentasJanuary: TIntegerField;
    qrVentasFebruary: TIntegerField;
    qrVentasMarch: TIntegerField;
    qrVentasApril: TIntegerField;
    qrVentasMay: TIntegerField;
    qrVentasJune: TIntegerField;
    qrVentasJuly: TIntegerField;
    qrVentasAugust: TIntegerField;
    qrVentasSeptember: TIntegerField;
    qrVentasOctober: TIntegerField;
    qrVentasNovember: TIntegerField;
    qrVentasDecember: TIntegerField;
...
begin
  ...
  Self.Caption:= 'Productos depachados Desde: ' + Desde.Text + ' Hasta: ' + Hasta.Text +' (Sucursal ' + DM.qrSucursal.FieldByName('NOMBRE').Value + ')';
...
begin
  inherited;
    ...
    Self.Caption:= 'Productos despachados     Desde: ' + Desde.Text + ' Hasta: ' + Hasta.Text +' (Sucursal ' + DM.qrSucursal.FieldByName('NOMBRE').Value + ')';
