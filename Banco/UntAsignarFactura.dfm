inherited FrmAsignarFactura: TFrmAsignarFactura
  Caption = 'Asignar Factura a Empresa'
  ClientHeight = 800
  ClientWidth = 1444
  ExplicitLeft = -643
  ExplicitTop = 3
    ...
    object cxTabSheet2: TcxTabSheet
      ...
      object cxGrid1: TcxGrid
        ...
        object cxGridDBTableView1: TcxGridDBTableView
          ...
          FilterBox.Visible = fvNever
          DataController.DataModeController.SmartRefresh = True
          DataController.DataSource = dsPendiente
          DataController.DetailKeyFieldNames = 'ENTRADAID'
          DataController.Filter.Active = True
          DataController.Filter.AutoDataSetFilter = True
          DataController.KeyFieldNames = 'ENTRADAID'
  ...
  object dsPendiente: TDataSource
    AutoEdit = False
    DataSet = qrSeleccionados
    Left = 132
    Top = 311
  end
  object qrSeleccionados: TADOQuery
