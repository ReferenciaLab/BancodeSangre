...
begin
  if pcDatos.ActivePage = tsMain then begin
    ...
    dxPrintGridLink.PrinterPage.PageHeader.LeftTitle.Clear;
    dxPrintGridLink.PrinterPage.PageHeader.LeftTitle.Add( UpperCase(DM.TituloEmpresa) );
    dxPrintGridLink.PrinterPage.PageHeader.LeftTitle.Add(Uppercase(Caption));
    dxPrintGridLink.PrinterPage.PageHeader.LeftTitle.Add('');
    dxPrintGrid.CurrentLink := dxPrintGridLink
  end else begin
    dxPrintGridDatos.ReportTitle.Text := Uppercase(Caption);
...
begin
  ...
  if ValidateRecord( dsDatos.DataSet ) then begin
