...
begin
  ...
  begin
    ...
    begin
      Result := True;
      MessageDlg('Este número de documento corresponde al donante '+
                 qfind.FieldByName('nombre').AsString+', Código '+qfind.FieldByName('clienteid').AsString, mtWarning, [mbOK], 0);
    end;
  end
  Else
  begin
