inherited frmCausasRechazosMeses: TfrmCausasRechazosMeses
  Caption = 'Estadisticas de rechazos por meses'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited dxPrintGrid: TdxComponentPrinter
    inherited dxPrintGridLink: TdxGridReportLink
      ...
      ReportDocument.CreationDate = 39995.860173310180000000
  ...
  object qrVentas: TADOQuery
    ...
    SQL.Strings = (
      ...
      '  DATEPART(Year, dbo.BSDonacion.Fecha) AS Periodo,'
      '  DATENAME(month, dbo.BSDonacion.Fecha) AS Mes,'
      '  CASE'
      
        '    WHEN dbo.BSDonacion.DonacionStatus = '#39'Procesada'#39' THEN '#39'Aprob' +
        'ada'#39
      
        '    WHEN dbo.BSDonacion.DonacionStatus = '#39'Rechazado'#39' THEN '#39'Recha' +
        'zada'#39
      '    ELSE '#39'Proceso'#39
      '  END AS Estado, dbo.BSCausasRechazo.Causa,'
      '  COUNT(*) AS Cantidad'
      ...
      'GROUP BY'
      '  dbo.BSCausasRechazo.Causa,'
      
        '  DATEPART(Year, dbo.BSDonacion.Fecha), DATENAME(month, dbo.BSDo' +
        'nacion.Fecha),'
      '  CASE'
    ...
    object qrVentasCausa: TStringField
      FieldName = 'Causa'
      Size = 50
    end
