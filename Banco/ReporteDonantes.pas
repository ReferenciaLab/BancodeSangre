...
type
  TfrmReporteDonantes = class(TfrmDialogModule)
    ppReporte: TppReport;
...
var
  frmReporteDonantes: TfrmReporteDonantes;

implementation

{$R *.dfm}

procedure TfrmReporteDonantes.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmReporteDonantes.Run;
begin
