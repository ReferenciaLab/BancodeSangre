...
function TfrmPuntoVenta_Backup.ImporteBrutoExclLineaActualAndCobertura(refrecid : integer ;secuencia : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVenta_Backup.btcobrarClick(Sender: TObject);
begin
  inherited;
...
//Actualizando los Datos del Cliente (Poliza - Aseguradora).
procedure TfrmPuntoVenta_Backup.Act_Seguro_Cliente;
Var
...
procedure TfrmPuntoVenta_Backup.ppSummaryBand1BeforePrint(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVenta_Backup.ppSummaryBand3BeforePrint(Sender: TObject);
begin
  inherited;
  //Buscando los Datos del Cliente.
  Buscar_Cliente;
...
procedure TfrmPuntoVenta_Backup.ppDetailBand5BeforePrint(Sender: TObject);
begin
  inherited;
