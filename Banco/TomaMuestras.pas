...
uses
  ...
  cxMemo, DateUtils, cxBlobEdit, ppBands, ppPrnabl, ppClass, ppCtrls, ppBarCod,
...
type
  TfrmTomaMuestras = class(TfrmCustomModule)
    ...
    plEtiqueta: TppDBPipeline;
    plEtiquetappField1: TppField;
    plEtiquetappField2: TppField;
    plEtiquetappField3: TppField;
    plEtiquetappField4: TppField;
    plEtiquetappField5: TppField;
    plEtiquetappField6: TppField;
    plEtiquetappField7: TppField;
    plEtiquetappField8: TppField;
    plEtiquetappField9: TppField;
    plEtiquetappField10: TppField;
    plEtiquetappField11: TppField;
    plEtiquetappField12: TppField;
    plEtiquetappField13: TppField;
    plEtiquetappField14: TppField;
    plEtiquetappField15: TppField;
    plEtiquetappField16: TppField;
    plEtiquetappField17: TppField;
    plEtiquetappField18: TppField;
    plEtiquetappField19: TppField;
    plEtiquetappField20: TppField;
    plEtiquetappField21: TppField;
    plEtiquetappField22: TppField;
    plEtiquetappField23: TppField;
    plEtiquetappField24: TppField;
    plEtiquetappField25: TppField;
    plEtiquetappField26: TppField;
    plEtiquetappField27: TppField;
    plEtiquetappField28: TppField;
    plEtiquetappField29: TppField;
    plEtiquetappField30: TppField;
    plEtiquetappField31: TppField;
    plEtiquetappField32: TppField;
    plEtiquetappField33: TppField;
    plEtiquetappField34: TppField;
    plEtiquetappField35: TppField;
    plEtiquetappField36: TppField;
    plEtiquetappField37: TppField;
    plEtiquetappField38: TppField;
    plEtiquetappField39: TppField;
    plEtiquetappField40: TppField;
    plEtiquetappField41: TppField;
    plEtiquetappField42: TppField;
    plEtiquetappField43: TppField;
    plEtiquetappField44: TppField;
    plEtiquetappField45: TppField;
    plEtiquetappField46: TppField;
    plEtiquetappField47: TppField;
    plEtiquetappField48: TppField;
    plEtiquetappField49: TppField;
    plEtiquetappField50: TppField;
    plEtiquetappField51: TppField;
    plEtiquetappField52: TppField;
    plEtiquetappField53: TppField;
    ...
    qrEtiquetaMuestraNo: TStringField;
    qrEtiquetaSecuencia: TIntegerField;
    qrEtiquetaSucursal: TStringField;
    qrEtiquetaDeptId: TStringField;
    qrEtiquetaPacienteId: TStringField;
    qrEtiquetaDescripcion: TStringField;
    qrEtiquetaEntradaId: TStringField;
    qrEtiquetaRecid: TLargeintField;
    qrEtiquetaPruebaID: TStringField;
    qrEtiquetaDescDept: TStringField;
...
uses ActionsDM, cxExportGrid4Link, DataModule, Main, DataBanco;

{$R *.dfm}


//Buscando el Label de la Prueba Registrada.
function TfrmTomaMuestras.Buscar_Labels(muestra: String; prueba: String): Boolean;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmTomaMuestras.CrearLabels(SecActual: Integer);
var
...
procedure TfrmTomaMuestras.InsertarLabel;
var
 Valor      : String;
 Qinsert    : TADOQuery;
 labelrecid : Integer;
...
begin
 inherited;
  ...
  while not qrEntradaPacienteDetalle.Eof do
    begin
      qrLabel.Close;
      qrlabel.Parameters.ParamByName('MuestraNo').Value:= qrEntradaPacienteDetalleMuestraNo.Value;
      qrlabel.Parameters.ParamByName('DeptId').Value:= tbPruebaDepartamento.Value;
      qrlabel.Open;

      if qrlabel.Eof then
        begin
          qrlabel.Insert;
          qrLabelMuestraNo.Value:= qrEntradaPacienteDetalleMuestraNo.Value;
...
procedure TfrmTomaMuestras.ImprimirLabel;
var
 qfind    : TADOQuery;
 texto    : TextFile;
 labels   : Integer;
...
//                   ' WHERE a.EntradaId = '+ #39 + qrEntradaPacienteEntradaId.Value + #39 +
  ...
  qrEtiqueta.Close;
  qrEtiqueta.Parameters.ParamByName('EntradaId').Value:= qrEntradaPacienteEntradaId.Value;
  qrEtiqueta.Parameters.ParamByName('MuestraNo').Value:= qrEntradaPacienteMuestraNo.Value;
  qrEtiqueta.Open;

 labels := qrEtiqueta.RecordCount;

 qfind.First;
 While Not qrEtiqueta.Eof Do
  begin
    rptEtiqueta.Print;
  end;
end;
