...
type
  TfrmPuntoVenta = class(TfrmCustomModule)
    ...
    tbCobro: TADOTable;
    dsCobro: TDataSource;
    tbCobroCobroID: TStringField;
    tbCobroTurnoID: TStringField;
    tbCobroEntradaID: TStringField;
    tbCobroSucursalID: TStringField;
    tbCobroFecha: TDateTimeField;
    tbCobroHora: TStringField;
    tbCobroPacienteID: TStringField;
    tbCobroPacientePrincipalID: TStringField;
    tbCobroUsuarioID: TStringField;
    tbCobroTotalCobrado: TBCDField;
    tbCobrorefRecid: TLargeintField;
    tbCobroTotalFactura: TBCDField;
    tbCobroTotalPagado: TBCDField;
    tbCobroPendienteFactura: TBCDField;
    tbCobroPendienteCobro: TBCDField;
    tbCobroReciboNo: TStringField;
    tbCobroClienteID: TStringField;
    tbCobroAplicado: TBooleanField;
    tbCobroSecuencia: TLargeintField;
    tbCobroMonedaID: TStringField;
    tbCobroTipoDoc: TStringField;
    tbCobroCuadreGlobal: TStringField;
    tbCobroCuadreUsuario: TStringField;
    tbCobroConcepto: TStringField;
    btHistroico: TcxButton;
    lgBotonesItem2: TdxLayoutItem;
    lcGeneralItem5: TdxLayoutItem;
    lcGeneralGroup11: TdxLayoutGroup;
    cxButton1: TcxButton;
    qrCliente: TADOQuery;
    qrClienteEmpresaId: TAutoIncField;
    qrClienteCodigo: TStringField;
    qrClienteNombre: TStringField;
    qrClienteRNC: TStringField;
    qrClienteTelefono: TStringField;
    qrClienteTelefono1: TStringField;
    qrClienteFAX: TStringField;
    qrClienteNCFTipo: TStringField;
    ...
    tbClienteCLIENTEID: TStringField;
    tbClienteNOMBRE: TStringField;
    tbClienteNOMBRE1: TStringField;
    tbClienteAPELLIDOS: TStringField;
    tbClienteCONTACTO: TStringField;
    tbClienteTELEFONO: TStringField;
    tbClienteFAX: TStringField;
    tbClienteGRUPOCLIENTE: TStringField;
    tbClienteINCLUIRPRECIOTICKET: TIntegerField;
    tbClienteAUTOCONFIRMAR: TIntegerField;
    tbClienteEMPLEADOID: TStringField;
    tbClienteCODIGOAXAPTA: TStringField;
    tbClienteEMAIL: TStringField;
    tbClienteDIRECCIONWEB: TStringField;
    tbClienteTELEFONO2: TStringField;
    tbClienteMONEDAID: TStringField;
    tbClienteIDENTIFICACION: TStringField;
    tbClienteORIGEN: TIntegerField;
    tbClienteDIRECCION: TStringField;
    tbClienteCIUDADID: TStringField;
    tbClientePRUEBASPORDIA: TIntegerField;
    tbClienteCOBERTURAPORC: TBCDField;
    tbClientePRINCIPAL: TStringField;
    tbClienteENVIORESULTADO: TIntegerField;
    tbClientePUBLICARINTERNET: TIntegerField;
    tbClienteFECHANACIMIENTO: TDateTimeField;
    tbClienteSEGURO: TStringField;
    tbClienteCARNETNUMERO: TStringField;
    tbClientePOLIZA: TStringField;
    tbClienteCOBRARDIFERENCIA: TIntegerField;
    tbClienteENVIARFAX: TIntegerField;
    tbClienteACTIVARDESCUENTOS: TIntegerField;
    tbClienteUSARALIASNOMBRE: TIntegerField;
    tbClienteUSARALIASPRUEBAS: TIntegerField;
    tbClienteSIEMPREINTERNET: TIntegerField;
    tbClienteIMPRIMIRALIASNOMBRE: TIntegerField;
    tbClienteIMPRIMIRALIASPRUEBA: TIntegerField;
    tbClienteIMPRIMIRSOLOTOTALES: TIntegerField;
    tbClienteIMPRIMIRALIASRESULTADOS: TIntegerField;
    tbClienteUSARACUERDOPROPIO: TIntegerField;
    tbClienteALIAS: TStringField;
    tbClienteQUIENPAGA: TStringField;
    tbClienteTIPOCLIENTE: TStringField;
    tbClienteENTREGARRESULTADOS: TStringField;
    tbClienteTEXTOREFERENCIA: TStringField;
    tbClienteSIEMPREIMPRIMIR: TIntegerField;
    tbClienteTIPOSANGRE: TStringField;
    tbClientePACIENTECIAID: TStringField;
    tbClienteSECTOR: TStringField;
    tbClienteUSUARIOINTERNET: TStringField;
    tbClienteCLAVEINTERNET: TStringField;
    tbClienteTIPOINTERNET: TStringField;
    tbClienteCLASECREDITO: TStringField;
    tbClienteDOCTORID: TStringField;
    tbClienteDATAAREAID: TStringField;
    tbClienteRECID: TIntegerField;
    tbClientemsrepl_tran_version: TGuidField;
    tbClienteSEXO: TIntegerField;
    tbClienteESTATUS: TIntegerField;
    tbClienteTIPOCLIENTEAS400: TIntegerField;
    tbClienteSEX: TStringField;
    tbClienteEdad: TIntegerField;
    procedure cxButton2Click(Sender: TObject);
    procedure EdClientePropertiesChange(Sender: TObject);
    procedure cxButton1Click(Sender: TObject);
    procedure btHistroicoClick(Sender: TObject);
    procedure EdPacientePropertiesChange(Sender: TObject);
...
uses ActionsDM, DataModule, Main, Pymeconst, DataBanco, BancoVenta;
...
procedure TfrmPuntoVenta.cxButton1Click(Sender: TObject);
var
  Empresa: String;
begin
  inherited;
  ...
  if (trim(Empresa) <> '' ) then
    begin
      if not (qrEntradaPaciente.State in [dsEdit, dsInsert]) then
        ...
        EDCliente.Text:= Empresa;
        qrEntradaPacienteCLIENTENOMBRE.Value:= qrClienteNombre.Value;
    end;

end;

procedure TfrmPuntoVenta.cxButton2Click(Sender: TObject);
var
  Empresa: String;
begin
  inherited;
...
function TfrmPuntoVenta.ImporteBrutoExclLineaActual(refrecid : integer ;secuencia : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVenta.ImporteBrutoExclLineaActualAndCobertura(refrecid : integer ;secuencia : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVenta.TotalDescuentoLinea : Double;
var
...
function TfrmPuntoVenta.ImporteLinea : Double;
Var
...
function TfrmPuntoVenta.CoberturaAplicada : Double;
var
...
begin
 ...
 if continuar then
   Begin
    Operacion := '';
      Self.recid := DMB.EntradaPendiente;
      Self.BuscarDatos;
      Self.RefrescarInterface;
      //frmMain.LanzaVentana(-7995);
   end;

   //if not (qrEntradaPaciente.State in [dsinsert,dsedit]) then
     //if DM.Mensaje('Desea Salir del modulo de caja?',mb_yesno) = id_yes then
      //Self.Release;
...
begin
 ...
 if ValidateRecord(dsEntradaPaciente.DataSet) then // and ValidateCliente then
  begin
...
//   If ( Operacion <> '' ) Then
     ...
     if (trim(qrEntradaPacienteNCF.Value) = '') then
      begin
       if (trim(cxDBTextEdit9.Text) = '') then
          begin
            if not(qrEntradaPaciente.State in [dsInsert, dsEdit]) then
              qrEntradaPaciente.Edit;
              qrEntradaPacienteNCF.Value:= DMB.GetNCF('02');
              qrEntradaPaciente.Post;
          end
        else
          begin
            qrEntradaPaciente.Edit;
            qrEntradaPacienteNCF.Value:= DMB.GetNCF(qrClienteNCFTipo.Value);
            qrEntradaPaciente.Post;
          end;
      end;
...
//    If (qfindSucursal.FieldByName('Impresiones').AsBoolean <> True) Then
    If (qfindSucursal.FieldByName('Impresiones').AsInteger <> 1) Then
     ...
     DMB.PasarVenta(qrEntradaPacienteRecId.Value);

{     if qrEntradaPaciente.State in [dsEdit, dsInsert] then
       Begin
//        Mirar_Valor_CAB;
        qrEntradaPaciente.Edit;
        qrEntradaPacienteSTATUS.Value := 'Vendido';
        qrEntradaPaciente.Post;
       end;}
...
procedure TfrmPuntoVenta.btHistroicoClick(Sender: TObject);
var
 continuar : Boolean;
begin
  inherited;
...
begin
  ...
  begin
   ...
   if (ValorNC > 0 ) then
    begin
      BV.AddNotaCredito(self.qrEntradaPacienteEntradaId.Value, ValorNC);
    end;
...
begin
 ...
 {if (qrEntradaPacienteEntradaID.asstring = '') and ( trim(qrEntradaPacienteRecid.AsString) <> '' ) then
    begin
      DM.DataBase.Execute('Delete from PTGastosVarioTrans Where Refrecid = '+qrEntradaPacienteRecid.AsString);
      DM.DataBase.Execute('Delete from PTMaterialesFactura Where Refrecid = '+qrEntradaPacienteRecid.AsString); //TOMA DE MUESTRA
    end;}
...
procedure TfrmPuntoVenta.qrEntradaPacienteDetalleBeforeDelete(
  DataSet: TDataSet);
begin
  inherited;
  if ( qrEntradaPacienteDetalleCoberturaAplica.Value = 1) then
...
procedure TfrmPuntoVenta.qrEntradaPacienteDetalleDescuentoChange(
  Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVenta.qrEntradaPacienteDetalleNewRecord(DataSet: TDataSet);
begin
  inherited;
...
procedure TfrmPuntoVenta.EdPacientePropertiesChange(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVenta.qrEntradaPacienteNombrePacienteValidate(
  Sender: TField);
begin
  inherited;
  if (qrEntradaPacienteOrigen.Value = DM.qrParametroGrupoLab.Value) then
...
begin
 qfind := DM.NewQuery;
 qfind.Close;
 //qfind.SQL.Text := 'SELECT * FROM PTCobro WHERE refrecId = '+#39+cobroID+#39;
 qfind.SQL.Text := 'SELECT * FROM PTCobro ' +  //WHERE ( PendienteCobro < 0.01) ' +
 ...
 if qfind.RecordCount > 0 then
    begin
      result := True;
      CobroId:= qfind.fieldbyname('CobroId').asstring;
    end
 else
   result := false;
...
procedure TfrmPuntoVenta.EdClientePropertiesChange(Sender: TObject);
begin
  inherited;

  qrCliente.Close;
  qrCliente.Parameters[0].Value:= EdCliente.Text;
  qrCliente.Open;
...
begin
 If ( qrEntradaPacienteNeto.Value > 0.01 ) And
    ( qrentradaPacienteBruto.Value > 0.01 ) //And ( qrEntradaPacienteTotalPendiente.Value > 0.01 )
    Then
   Begin
     CrearCobro;
     RefrescarCobro;
...
begin
 ...
 //tbCobro.Open;
 //pendiente := tbCobroPendienteCobro.AsCurrency;
 //tbCobro.Close;

 //pendiente := 0;
 pendiente := qrEntradaPacienteNETO.AsCurrency - qrEntradaPacienteTotalPagado.AsCurrency;
 ...
 monto1 := qrEntradaPacienteNETO.Value;
...
//  qinsert.Parameters[5].Value := qrEntradaPacienteMonedaID.Value;
  ...
  qinsert.Parameters[6].Value := DM.ValorMoneda(monto1,qrEntradaPacienteMonedaID.Value,DM.qrParametroMonedaID.Value,DM.SystemDate);
  qinsert.ExecSQL;
...
begin
 ...
 //Cargando las Formas de Pago en Peso.
 If (qrEntradaPacienteTipoDocumento.Value <> 3)
   //Or (QrEntradaPacienteFactExterior.Value = 0)
 Then
   Begin
     qfind := DM.NewQuery;
     qfind.Close;
 ...
 //Cargando las Formas de Pago en Dolares.
 If (qrEntradaPacienteTipoDocumento.Value = 3)
    //Or (QrEntradaPacienteFactExterior.Value = 1)
 Then
   Begin
     qfind := DM.NewQuery;
     qfind.Close;
  ...
  begin
   ...
   mdPagorefrecid.Value := qrEntradaPacienteRECID.AsInteger;
   //qfind.FieldByName('recid').AsInteger;
...
begin
 ...
 qupdate := DM.NewQuery;
 qupdate.Close;
 qupdate.SQL.Text := 'Update PTCobroDetalle Set Monto = :mont, MontoMST = :mon2 where refRecid = :rec AND Orden = :Orden';
 ...
 begin
  ...
  qupdate.Parameters[1].Value := DM.ValorMoneda(mdPagoPagado.Value,
                                                ...
                                                DM.SystemDate);
  qupdate.Parameters[2].Value := qrEntradaPacienteRECID.AsInteger;
  qupdate.Parameters[3].Value := mdPagoOrden.Value;

  //mdPagorefrecid.Value;
  qupdate.ExecSQL;
...
procedure TfrmPuntoVenta.ppHeaderBand3BeforePrint(Sender: TObject);
begin
...
function TfrmPuntoVenta.Buscar_Labels(muestra: String; prueba: String): Boolean;
Var
 qfind : TADOQuery;
 valor : Boolean;
begin
...
procedure TfrmPuntoVenta.CrearLabels(SecAct: Integer);
var
...
procedure TfrmPuntoVenta.InsertarLabel;
var
 Qinsert    : TADOQuery;
 labelrecid : Integer;
begin
...
procedure TfrmPuntoVenta.ImprimirLabel;
var
 qfind  : TADOQuery;
 texto  : TextFile;
 cadena : String;
...
procedure TfrmPuntoVenta.Procesar_Usuario;
Var
  Valor : Boolean;
  Pass2, Clave : Integer;
...
procedure TfrmPuntoVenta.Insertar_Usuario(usuario: string; clave: string; name: string; cedula: string;
...
//Validando la Existencia del Usuario Creado.
Function TfrmPuntoVenta.Buscar_User_Internet(Cliente : String) : Boolean;
Var
 qfind  : TAdoQuery;
begin
