inherited frmBSProductosReservados: TfrmBSProductosReservados
  Caption = 'Productos reservados'
  ClientHeight = 622
  ClientWidth = 1002
  ExplicitWidth = 1010
  ExplicitHeight = 656
    ...
    object TdxLayoutControl
      ...
      object cgDatos: TcxGrid
        ...
        object dbDatos: TcxGridDBTableView
          ...
          object dbDatosReceptor: TcxGridDBColumn
  ...
  object qrDetalles: TADOQuery
    ...
    SQL.Strings = (
        ...
        'le, dbo.BSInventario.Vence, '
      
        '                      dbo.BSDonante.TipoSangre, dbo.BSDonante.RH' +
        ', dbo.BSInventario.ReceptorId, dbo.PTCLIENTE.NOMBRE AS Receptor,' +
        ' dbo.PTCLIENTE.TELEFONO, '
      
        '                      dbo.PTCLIENTE.CONTACTO, dbo.BSInventario.D' +
        'octorId, dbo.BSInventario.Precio1, dbo.BSInventario.Costo1, dbo.' +
        'BSDonacion.PacienteID AS Donante, '
      ...
      'FROM         dbo.BSDonacion INNER JOIN'
        ...
        '                      dbo.PTCLIENTE ON dbo.BSInventario.Receptor' +
        'Id = dbo.PTCLIENTE.CLIENTEID INNER JOIN'
      
        '                      dbo.BSProductos ON dbo.BSInventario.Produc' +
        'toID = dbo.BSProductos.ProductoID'
      'WHERE     (dbo.BSInventario.Reservado = 1)')
    Left = 312
    Top = 155
    ...
    object qrDetallesReceptorId: TStringField
      FieldName = 'ReceptorId'
      Size = 10
    end
    object qrDetallesReceptor: TStringField
      FieldName = 'Receptor'
      Size = 80
    end
    object qrDetallesTELEFONO: TStringField
      FieldName = 'TELEFONO'
    end
    object qrDetallesCONTACTO: TStringField
      FieldName = 'CONTACTO'
      Size = 80
    end
    object qrDetallesDoctorId: TStringField
      FieldName = 'DoctorId'
      Size = 10
    end
    object qrDetallesPrecio1: TBCDField
      FieldName = 'Precio1'
      Precision = 19
    end
    object qrDetallesCosto1: TBCDField
      FieldName = 'Costo1'
      Precision = 19
    end
    object qrDetallesDonante: TStringField
      FieldName = 'Donante'
      Size = 10
    end
