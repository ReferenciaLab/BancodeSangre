...
uses
  ...
  cxGroupBox, cxRadioGroup, cxCalendar;
...
begin
  inherited;
  If (qrPlanesEmpresa.State = dsInsert) or (qrPlanesEmpresa.State = dsEdit) then
    Raise exception.CreateFmt('Debe Grabar Antes de Agregar los Combos de Este Chequeo Anual', [])
  Else
...
begin
  inherited;
  If (qrPlanesEmpresa.State = dsInsert) or (qrPlanesEmpresa.State = dsEdit) then
    Raise exception.CreateFmt('Debe Grabar Antes de Agregar los Empleados de Este Chequeo Anual', [])
  Else
