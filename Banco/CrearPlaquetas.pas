...
type
  TfrmCrearPlaquetas = class(TfrmCustomModule)
    pnBusqueda: TPanel;
    pnLista: TPanel;
    pnBotones: TPanel;
    dsCrio: TDataSource;
...
var
  frmCrearPlaquetas: TfrmCrearPlaquetas;
...
procedure TfrmCrearPlaquetas.acCrearExecute(Sender: TObject);
begin
  inherited;
  //Crear Crioprecipitado
  dmi.CrearPlaquetas(qrCrioCodigoId.Value);

end;

procedure TfrmCrearPlaquetas.edProductoChange(Sender: TObject);
var
  tmp: String;
begin
  inherited;
...
procedure TfrmCrearPlaquetas.FormCreate(Sender: TObject);
begin
  inherited;
